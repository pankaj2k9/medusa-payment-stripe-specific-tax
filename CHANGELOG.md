...
- [#4025](https://github.com/medusajs/medusa/pull/4025) [`cff54d732`](https://github.com/medusajs/medusa/commit/cff54d73253a4c2d16a174a28f0f5d31c94bcebd) Thanks [@adrien2p](https://github.com/adrien2p)! - fix(medusa-payment-stripe-specific-tax): Catch on idempotency key retrieve if not found
...
- [#3257](https://github.com/medusajs/medusa/pull/3257) [`589d1c09b`](https://github.com/medusajs/medusa/commit/589d1c09b085dcaf9667061201ac9deff3047466) Thanks [@adrien2p](https://github.com/adrien2p)! - feat(medusa-payment-stripe-specific-tax): Implement payment processor API on stripe plugin and fix web hook issues
...
- [#3046](https://github.com/medusajs/medusa/pull/3046) [`82da3605f`](https://github.com/medusajs/medusa/commit/82da3605fb50cef182699900552109ad654f0df2) Thanks [@adrien2p](https://github.com/adrien2p)! - feat(medusa-payment-stripe-specific-tax): Avoid unnecessary customer update if the stripe id already exists

- [#3100](https://github.com/medusajs/medusa/pull/3100) [`0009da026`](https://github.com/medusajs/medusa/commit/0009da02619e794537d88fa9494e35594ed1bb0c) Thanks [@olivermrbl](https://github.com/olivermrbl)! - fix(medusa-payment-stripe-specific-tax): Resend capture event to ensure auto-capture

- [#3185](https://github.com/medusajs/medusa/pull/3185) [`08324355a`](https://github.com/medusajs/medusa/commit/08324355a4466b017a0bc7ab1d333ee3cd27b8c4) Thanks [@olivermrbl](https://github.com/olivermrbl)! - chore: Patches all dependencies + minor bumps `winston` to include a [fix for a significant memory leak](https://github.com/winstonjs/winston/pull/2057)

- [#3160](https://github.com/medusajs/medusa/pull/3160) [`71fdd2819`](https://github.com/medusajs/medusa/commit/71fdd281986781a96f5c50205a4a3628ae8e6282) Thanks [@olivermrbl](https://github.com/olivermrbl)! - fix(medusa-payment-stripe-specific-tax): Prevent Stripe events from retrying
...
- [#2743](https://github.com/medusajs/medusa/pull/2743) [`c8724da50`](https://github.com/medusajs/medusa/commit/c8724da50300b94255c5fb4ffe9904be279b5923) Thanks [@adrien2p](https://github.com/adrien2p)! - feat(medusa,medusa-payment-stripe-specific-tax): Move database mutation from plugin to core
...
- [#2607](https://github.com/medusajs/medusa/pull/2607) [`e09f6e8a1`](https://github.com/medusajs/medusa/commit/e09f6e8a1e4a759fe70664bea0538c61b7cea70a) Thanks [@adrien2p](https://github.com/adrien2p)! - fix(medusa-payment-stripe-specific-tax): handle webhook sirialization failure

- [#2603](https://github.com/medusajs/medusa/pull/2603) [`9e91a50df`](https://github.com/medusajs/medusa/commit/9e91a50df17b4f542db8d9678b5f489218511adb) Thanks [@adrien2p](https://github.com/adrien2p)! - fix(medusa-payment-stripe-specific-tax): missing transaction on create payment
...
## [1.1.41](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.40...medusa-payment-stripe-specific-tax@1.1.41) (2022-07-05)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.40](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.38...medusa-payment-stripe-specific-tax@1.1.40) (2022-06-19)

### Features

- **medusa-payment-stripe-specific-tax:** Ability to add payment description and improve status resolution ([#1404](https://github.com/medusajs/medusa/issues/1404)) ([327614e](https://github.com/medusajs/medusa/commit/327614e126d57b1c53ca95b2298c8e4ec1dd34fb))

## [1.1.39](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.38...medusa-payment-stripe-specific-tax@1.1.39) (2022-05-31)

### Features

- **medusa-payment-stripe-specific-tax:** Ability to add payment description and improve status resolution ([#1404](https://github.com/medusajs/medusa/issues/1404)) ([327614e](https://github.com/medusajs/medusa/commit/327614e126d57b1c53ca95b2298c8e4ec1dd34fb))

## [1.1.38](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.37...medusa-payment-stripe-specific-tax@1.1.38) (2022-01-11)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.37](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.36...medusa-payment-stripe-specific-tax@1.1.37) (2021-12-29)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.36](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.35...medusa-payment-stripe-specific-tax@1.1.36) (2021-12-17)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.35](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.34...medusa-payment-stripe-specific-tax@1.1.35) (2021-12-08)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.34](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.33...medusa-payment-stripe-specific-tax@1.1.34) (2021-11-23)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.33](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.32...medusa-payment-stripe-specific-tax@1.1.33) (2021-11-22)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.32](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.31...medusa-payment-stripe-specific-tax@1.1.32) (2021-11-19)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.31](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.30...medusa-payment-stripe-specific-tax@1.1.31) (2021-11-19)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.30](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.29...medusa-payment-stripe-specific-tax@1.1.30) (2021-10-18)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.29](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.28...medusa-payment-stripe-specific-tax@1.1.29) (2021-10-18)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.28](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.26...medusa-payment-stripe-specific-tax@1.1.28) (2021-10-18)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.27](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.26...medusa-payment-stripe-specific-tax@1.1.27) (2021-10-18)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.26](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.25...medusa-payment-stripe-specific-tax@1.1.26) (2021-09-22)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.25](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.24...medusa-payment-stripe-specific-tax@1.1.25) (2021-09-15)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.24](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.23...medusa-payment-stripe-specific-tax@1.1.24) (2021-09-14)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.23](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.22...medusa-payment-stripe-specific-tax@1.1.23) (2021-08-05)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.22](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.21...medusa-payment-stripe-specific-tax@1.1.22) (2021-07-26)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.21](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.19...medusa-payment-stripe-specific-tax@1.1.21) (2021-07-15)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.20](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.19...medusa-payment-stripe-specific-tax@1.1.20) (2021-07-15)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.19](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.18...medusa-payment-stripe-specific-tax@1.1.19) (2021-07-02)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.18](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.17...medusa-payment-stripe-specific-tax@1.1.18) (2021-06-22)
...
## [1.1.17](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.16...medusa-payment-stripe-specific-tax@1.1.17) (2021-06-09)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.16](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.15...medusa-payment-stripe-specific-tax@1.1.16) (2021-06-09)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.15](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.14...medusa-payment-stripe-specific-tax@1.1.15) (2021-06-09)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.14](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.13...medusa-payment-stripe-specific-tax@1.1.14) (2021-06-09)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.13](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.12...medusa-payment-stripe-specific-tax@1.1.13) (2021-06-08)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.12](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.9...medusa-payment-stripe-specific-tax@1.1.12) (2021-04-28)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.11](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.10...medusa-payment-stripe-specific-tax@1.1.11) (2021-04-20)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.10](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.9...medusa-payment-stripe-specific-tax@1.1.10) (2021-04-20)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.9](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.8...medusa-payment-stripe-specific-tax@1.1.9) (2021-04-13)

### Bug Fixes

- merge develop ([a468c45](https://github.com/medusajs/medusa/commit/a468c451e82c68f41b5005a2e480057f6124aaa6))

## [1.1.8](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.7...medusa-payment-stripe-specific-tax@1.1.8) (2021-04-13)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.7](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.6...medusa-payment-stripe-specific-tax@1.1.7) (2021-03-30)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.6](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.5...medusa-payment-stripe-specific-tax@1.1.6) (2021-03-17)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.5](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.3...medusa-payment-stripe-specific-tax@1.1.5) (2021-03-17)
...
## [1.1.4](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.3...medusa-payment-stripe-specific-tax@1.1.4) (2021-03-17)
...
## [1.1.3](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.2...medusa-payment-stripe-specific-tax@1.1.3) (2021-02-17)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.2](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.1...medusa-payment-stripe-specific-tax@1.1.2) (2021-02-03)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.1.1](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.1.0...medusa-payment-stripe-specific-tax@1.1.1) (2021-01-27)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

# [1.1.0](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.0.15...medusa-payment-stripe-specific-tax@1.1.0) (2021-01-26)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.0.15](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.0.14...medusa-payment-stripe-specific-tax@1.0.15) (2020-12-17)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.0.14](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.0.13...medusa-payment-stripe-specific-tax@1.0.14) (2020-11-24)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.0.13](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.0.12...medusa-payment-stripe-specific-tax@1.0.13) (2020-10-19)

**Note:** Version bump only for package medusa-payment-stripe-specific-tax

## [1.0.12](https://github.com/medusajs/medusa/compare/medusa-payment-stripe-specific-tax@1.0.11...medusa-payment-stripe-specific-tax@1.0.12) (2020-10-12)
...
- **medusa-payment-stripe-specific-tax:** adds missing await in updateSession ([0cebcd2](https://github.com/medusajs/medusa/commit/0cebcd25211f32088e19e56dee095129ee2da86b))
